  ...
  return (
    <Modal>
      <div className="min-h-screen px-4 md:flex md:items-center md:justify-center">
        ...
        <div className="fixed inset-x-0 bottom-0 z-50 mx-4 mb-4 rounded-lg bg-white p-4 dark:bg-black md:relative md:mx-auto md:max-w-md">
          <div className="items-center md:flex">
            ...
            <div className="mt-4 text-center md:mt-0 md:ml-6 md:text-left">
              <p className="font-bold dark:text-white">{nameBtn}</p>
          ...
          <div className="mt-4 text-center md:flex md:justify-end md:text-right">
            <button
              className="block w-full rounded-lg bg-red-200 px-4 py-3 text-sm font-semibold text-red-700 dark:bg-red-600 dark:text-white md:order-2 md:ml-2 md:inline-block md:w-auto md:py-2"
